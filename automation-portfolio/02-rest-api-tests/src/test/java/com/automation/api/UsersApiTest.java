...
/**
 * Project 2: REST API tests with JDK HttpClient + TestNG.
...
public class UsersApiTest {
    ...
    public void createPostReturns201() throws Exception {
        String json = "{\"title\":\"automation test\",\"body\":\"hello\",\"userId\":1}";
        HttpRequest req = HttpRequest.newBuilder()
        ...
        Assert.assertTrue(res.body().contains("automation test"));
    }
}
